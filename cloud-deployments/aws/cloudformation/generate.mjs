...
// Xeta Assistantcan run within the free tier services of AWS (t2.micro w/10GB of storage)
//
// This will deploy a fully public Xeta Assistantso if you do not want anyone to access it please set the AUTH_TOKEN & JWT_SECRET envs
...
console.log(chalk.greenBright('[SUCCESS]'), 'Deploy Xeta Assistanton AWS CloudFormation using your template document.');
